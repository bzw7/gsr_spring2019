#####################################################################################
# Python script used in jupyter notebook to abstract generating a single trajectory##
#####################################################################################
...
def main(NUM_SAMPLES=1):
	# input number of samples and return num_samples trajectories (x and y labels)
	# NUM_SAMPLES = 1
	x_train,y_train=[],[]
